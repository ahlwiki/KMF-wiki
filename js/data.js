...
const knightmareFrames = [
    ...
    },
    {
        ...
        description: "格洛斯特（柯内莉亚版本）是专门为柯内莉亚·li·不列颠作为高端Knightmare驾驶员和指挥官技能定制设计的模型。与标准格洛斯特不同，型号为RPI-00/SC，其最显著的外观出现在成田战斗期间，并在柯内莉亚参与的每个其他主要战斗中出现。该单位在第一季结束时的黑色叛乱中严重受损，当时安德烈亚斯·达顿在鲁路修Geass的影响下，将他的电磁骑枪投向它，刺穿驾驶舱，重伤柯内莉亚，并永久退役该单位。",
        specs: {
            height: "4.84m",
            weight: "7.75t",
            armor: "钨",
        ...
        combat: `<p>它首次出现在成田战斗，并出现在柯内莉亚参与的每个其他主要战斗中。该单位在黑色叛乱中严重受损，当时安德烈亚斯·达顿在鲁路修Geass的影响下，将他的电磁骑枪投向它，刺穿驾驶舱，重伤柯内莉亚，并永久退役该单位。</p>`
    }
];
