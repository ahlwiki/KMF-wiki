...
const knightmareFrames = [
    ...
    },
    {
        ...
        combat: `<p>在克里斯蒂娜·帕拉领导的20区开发，德拉·巴雷塔担任布莱顿的测试驾驶员。当皇帝用他的Geass将Zero的记忆赐予詹姆斯·埃罗作为追踪C.C.计划的一部分，并在俾斯麦·瓦尔德斯坦的命令下，克里斯蒂娜充当詹姆斯的联系人，并给了他激活密钥、布莱顿的代码以及如何偷窃并将其返回11区的指示。然而，德拉 unaware 该计划，并驾驶桑德兰空中型出击阻止盗窃。尽管布莱顿证明优于对手机器，但由于詹姆斯自己的犹豫和对"他的"记忆日益增长的不确定性，他被击落并在机器的 destruction 中死亡。尽管这台机器被摧毁无法修复，克里斯蒂娜告诉德拉她仍然有计划和数据，可以建造另一台机器。</p><p>大约30台布莱顿单位最终被推出并参与战斗，包括在第二次袭击东京定居点期间。</p>`
    },
    {
        id: 5,
        name_zh: "无赖",
    ...
    },
    {
        ...
        description: "月下是基于红莲二式和月下原型的新模型，虽计划量产但仅生产五台作为原型机，拥有第六至第七世代技术，优于不列颠的当前量产模型桑德兰和格洛斯特。",
        specs: {
            height: "4.45m",
            weight: "7.92t",
            armor: "钨",
    ...
    },
    {
        ...
        specs: {
            ...
            developer: "神圣不列颠帝国",
            derivedFrom: "甘尼米德",
            development: "桑德兰、Portman、Somerset、Prytwen、Raiko、无赖定制型",
    ...
    },
    {
        ...
        description: "第五代RPI-209格洛斯特是专注于近战的桑德兰改造型。普通模型涂装为平坦的暗紫色，但一些军官单位有定制涂装。在ZERO的黑色叛乱失败后，格洛斯特取代了大部分桑德兰作为不列颠的主要Knightmare。",
        specs: {
            height: "4.29m",
            weight: "7.75t",
            armor: "钨",
    ...
    },
    {
        ...
        design: `<p>它不同于普通格洛斯特，头部两侧有角状天线阵列，以及更装饰性的腰部装甲。颜色是更亮、更鲜艳的紫色，披风白色。它还具备增强的徒手战斗能力。除了标准桑德兰装备外，柯内莉亚的格洛斯特通常使用大型骑枪和突击步枪。骑枪包含一组在四个侧面的扩展叉，可以捕获和解除敌人武器。结合格洛斯特的高机动性和动力，这种可怕的武器可用于直接穿透敌人Knightmare的驾驶舱，杀死驾驶员并防止他通过标准弹射系统逃脱。</p>`,
    ...
    },
    {
        ...
        design: `<p>在神圣不列颠帝国开发了更优秀的Knightmare Frame桑德兰后，它比格拉斯哥更受青睐。因此，神圣不列颠帝国使用剩余的格拉斯哥并将它们改造成骑士警察。改进包括以白色为基础的涂装，在胸部、肩部和驾驶舱顶部安装红色旋转灯，以及改变手臂和下身的装甲形状。</p><p>作为改造的格拉斯哥，它仍然保留了常规格拉斯哥的所有特征。然而，由于是专门为不列颠警察部队制造的，它配备了一对位于新建枪套内的机枪手枪，而不是标准KMF的突击步枪，以及特制的反Knightmare战斗刀。此外，骑士警察框架在人群控制情况下也使用防暴盾，其中可能涉及枪支或流氓Knightmares。</p>`,
        combat: ""
    },
    {
        id: 23,
    ...
    },
    {
        ...
        weapons: {
            ...
            handheld: [
                ...
                { name: "2 × 微波振动剑", description: "使用高频振动的电子剪切武器，可瞬间切割桑德兰级机体装甲" }
            ]
        },
    ...
    },
    {
        ...
        combat: `<p>它参与了多次战斗，包括第二次袭击东京定居点和富士山战斗。莫德雷德在最后一集（Re;）中被杰里米亚·戈特瓦尔德的桑德兰齐格的残骸严重损坏，双臂和头部被炸掉；驾驶舱被破坏并暴露，但损坏并不太严重，因为集成浮空系统仍然功能正常。</p>`
    },
    {
        id: 28,
        name_zh: "MR-1",
    ...
    },
    {
        ...
        design: `<p>从兰斯洛特征服者的"Core Luminous Cone"、桑德兰的骑枪和高文的Hadron加农炮中汲取灵感，这台Knightmare Frame基于那些武装建造了类似的武器。其装甲异常笨重，具有从手腕延伸的大型圆锥、髋部和脚部的尖刺腿甲，以及从肩部和陆地滑行系统伸出的尖刺。它还有一个集成浮空系统用于飞行能力。珀西瓦尔的主要武器是右腕上的一个大爪。爪子可以重新配置并旋转，生成一个光辉盾牌场并将手臂转变为MVS粒子钻枪。它还可以使用头部和肩部的飞燕爪牙进行近程战斗。对于远程攻击，珀西瓦尔的尖刺髋甲可以打开，露出里面的Hadron冲击炮，以及其盾牌中的导弹发射器。</p>`,
    ...
    },
    {
        ...
        generation: "第5世代",
        type: "量产机",
        pilot: "杰雷米亚·哥特瓦尔德;维蕾塔·努;鲁路修·兰佩洛基等",
        images: [
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d0ab8ccfc.webp",
                description: "标准配色"
            },
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d0ab8fe7e.webp",
                description: "纯血派配色"
            },
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d0abc5ffd.webp",
                description: "日解战线配色"
            }
        ],
        image: "https://cdn4.winhlb.com/2025/10/29/6901d0ab8ccfc.webp",
        description: "桑德兰是第五世代Knightmare Frame，在不列颠尼亚征服日本/11区后开发并部署。作为RPI-11格拉斯哥的有效改进型，它是系列中不列颠尼亚军队的主力量产型Knightmare。",
        specs: {
            height: "4.39m",
            weight: "7.48t",
            armor: "钨",
            ...
            developer: "神圣不列颠帝国",
            derivedFrom: "格拉斯哥",
            development: "格洛斯特;兰斯洛特俱乐部;桑德兰·伊卡洛斯;等",
            variants: "桑德兰空中型;桑德兰俱乐部型;桑德兰·格林达;等"
        },
        equipment: {
            standard: [
                { name: "驾驶舱弹射系统", description: "" },
                { name: "事实球传感器", description: "" },
                { name: "陆地滑行推进系统", description: "经过大幅增强和改进，用于更高速度和更好战斗稳定性" },
                { name: "I.F.F. 应答系统", description: "" }
            ],
            optional: [
                { name: "浮空系统", description: "可选装备，装备后型号变更为RPI-13 桑德兰空中型" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x 肘部安装电击警棍", description: "现有警棍武器的升级版本，增加了电击枪功能" },
                { name: "1x 胸部安装机枪", description: "" }
            ],
            handheld: [
                { name: "1x 突击步枪", description: "" },
                { name: "1x 巨炮", description: "火箭发射器，重新设计后更像传统巴祖卡武器" },
                { name: "1x 突击长枪", description: "" },
                { name: "混沌地雷", description: "小型装备，存储在臀甲形状的储物舱中" }
            ],
            optional: [
                { name: "1x 反Knightmare狙击步枪", description: "" },
                { name: "2x Stattel Waffen导弹发射器", description: "驾驶舱安装的导弹发射器" },
                { name: "1x 战斧", description: "" },
                { name: "1x 弹道盾牌", description: "" }
            ]
        },
        design: `<p>作为第五代Knightmare之一，桑德兰采用了完全重新设计的简化驾驶舱系统，具有改进的生命支持功能和更好的用户界面控制。除了整体性能升级外，陆地滑行推进系统也得到极大增强，为更高速度和更好战斗稳定性而改进。机身大部分也完全重新设计，例如增加更多附加装甲板（具体称为"L307强化钨金属"装甲），重新塑形以更好地增加飞行员和机体的保护。头部也简化了，融入了独特的类似人形外观和内置眼睛，尽管仍保留与格拉斯哥相同的事实球传感器系统。还增加了臀甲形状的储物舱，用于存放混沌地雷等小型装备。此外，桑德兰具有独特但非常规的蓝/紫色主体颜色和灰色次要装饰。这种军事蓝/紫色调将被帝国未来的量产模型所采用，例如RPI-212B文森特。</p><p>此外，桑德兰的引入带来了许多新武器和技术，例如驾驶舱安装的Stattel-Waffen导弹发射器、电磁突击长枪、电击警棍（现有警棍武器的升级版本，但增加了电击枪功能，使金属警棍通电）和前述的混沌地雷。大多数陆军桑德兰单位配备突击步枪或巨炮火箭发射器，后者也经过重新设计，发射方式更像传统的巴祖卡武器。所有上述武器都将在未来开发的Knightmare Frame中继续使用。</p>`,
        combat: `<p>桑德兰首次部署的确切日期未知，但是在2010年a.t.b.入侵日本之后的某个时间，到2016-2017年a.t.b.时，它已完全取代老化的格拉斯哥，成为不列颠尼亚军队的前线Knightmare Frame。在第一次黑色叛乱期间，桑德兰几乎出现在所有重大战役事件中。它们通常在背景中扮演非常次要的角色，并且几乎总是由不列颠尼亚军队操作。然而，在某些孤立事件中，它们被反不列颠尼亚抵抗组织成员甚至黑色骑士团驾驶，通常通过盗窃或叛逃的方式，其中一些缴获的单位甚至被重新涂装或重新设计，以与不列颠尼亚主力部队区分开（例如黑色骑士团将一些单位重新涂成深绿色）。</p><p>到2018年a.t.b.，许多桑德兰似乎已被RPI-209格洛斯特取代，尽管此时桑德兰仍作为不列颠尼亚主要量产型Knightmare，而格洛斯特机器担任战场指挥官/精英飞行员角色。桑德兰在与E.U.的战争中也发挥了重要作用，并且在R2过程中可以看到它们与格洛斯特并肩作战。最终，浮空单元的生产变得更加普遍，许多桑德兰配备了这项新技术，使它们能够飞行。这导致一些桑德兰被改编入空军，为更大的空中舰艇执行护航任务，取代了对传统喷气式战斗机的需求。</p><p>在2018年a.t.b.的晚些时候，对新型量产型Knightmare的需求导致了RPI-212B文森特的开发，以对抗第七代敌方机器。然而，尽管新一代量产型Knightmare快速部署，桑德兰仍在不列颠尼亚军队中扮演显著角色，这很可能是由于其生产数量和整体可靠的设计。在鲁路修皇帝统治期间，一些桑德兰与格洛斯特一起被用作前线单位，尽管它们的作用和重要性由于更新的文森特和文森特指挥官型号占据了鲁路修皇帝Knightmare部队的一半而有所降低。</p>`
    },
    {
        id: 38,
        name_zh: "桑德兰可翔式",
        name_en: "Sutherland Flight-Enabled",
        model: "RPI-13/F2",
        faction: "black-knights",
        generation: "第5世代",
        type: "量产机",
        pilot: "杰雷米亚·哥特瓦尔德",
        image: "https://cdn4.winhlb.com/2025/10/29/6901d0abbb318.webp",
        description: "桑德兰可翔式是杰雷米亚·哥特瓦尔德加入黑色骑士团后使用的桑德兰改装机，配备了空力滑翔翼系统以获得飞行能力。",
        specs: {
            height: "4.39m",
            weight: "8.47t",
            armor: "钨",
        ...
        equipment: {
            standard: [
                { name: "空力滑翔翼", description: "用于飞行的可选装备" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x 飞燕爪牙", description: "" },
                { name: "1x 右臂安装火箭炮", description: "来自晓机的标准火箭炮" }
            ],
            handheld: [
                { name: "1x 突击步枪", description: "" }
            ]
        },
        design: `<p>这是一台采用纯血派配色的标准桑德兰，为其配备了空力滑翔翼系统以支持飞行，并安装了晓机使用的标准火箭炮。</p>`,
        combat: `<p>桑德兰可翔式仅在一次作战中投入战斗，即对Geass教团基地的突袭行动。</p>`
    },
    {
        id: 39,
        name_zh: "特里斯坦",
        ...
        type: "专用机",
        pilot: "吉诺·温伯格",
        image: "https://cdn4.winhlb.com/2025/10/29/6901d0abd6304.webp",
        description: "特里斯坦是神圣不列颠帝国为第三圆桌骑士吉诺·温伯格开发的第七世代可变形式Knightmare Frame，以圆桌骑士特里斯坦命名。它是首款成功开发的可变形Knightmare，能在人形和喷气式形态之间切换。",
        specs: {
            height: "5.45m",
            weight: "7.35t",
            armor: "钨",
        ...
        equipment: {
            standard: [
                { name: "飞燕爪牙推进器", description: "为飞燕爪牙提供额外推进力" },
                { name: "浮空系统", description: "" },
                { name: "陆地滑行推进系统", description: "" },
                { name: "驾驶舱弹射系统", description: "" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x 臂装式飞燕爪牙", description: "两个巨大的飞燕爪牙安装在前臂，可组合发射能量冲击" },
                { name: "2x 微波振动剑长柄武器", description: "类似镐状的MVS长柄武器，可在刀柄处连接形成双刃镰刀" }
            ],
            optional: [
                { name: "1x 能量炮", description: "由飞燕爪牙组合形成的能量武器" },
                { name: "2x 机枪", description: "仅在堡垒模式使用" }
            ]
        },
        design: `<p>特里斯坦是第七世代模型，以圆桌骑士命名，是首款开发的可变形Knightmare Frame，能够在人形（框架）和喷气式（堡垒）形态之间切换。它由第三圆桌骑士吉诺·温伯格驾驶。它具有高度机动性，能够在空中展开和变形。在其喷气形态下可以使用一对机枪。它有两个巨大的飞燕爪牙安装在前臂，配备了飞燕爪牙推进器。这两个飞燕爪牙可以组合发射能量冲击，威力足以有效匹配神虎的重子炮。在人形形态下，它可以挥舞两个称为MVS长柄武器的类似镐状的微波振动剑，这些武器可以在刀柄处连接形成一个双刃镰刀。</p>`,
        combat: `<p>作为圆桌骑士成员，王牌飞行员吉诺·温伯格被授予自己的研发团队，为他建造了定制的个人Knightmare Frame。这台名为RZA-3F9特里斯坦的机器专为适应吉诺的战斗风格和个人偏好而设计。特里斯坦是一种高机动性模型Knightmare，专门使用其飞燕爪牙和宽刃MVS长矛进行打了就跑的战术，快速而干净地切割敌人。在正常情况下已经很灵活的特里斯坦拥有变形成堡垒模式的能力，使其成为用于高速攻击的流线型战斗机。吉诺充分利用他的特里斯坦，直到被流放的不列颠尼亚王子鲁路修·兰佩洛基（前恐怖分子Zero）声称拥有不列颠尼亚王位并领导超级大国实现他自己的目的。吉诺站在忠于已故查理皇帝的一方，试图捕获鲁路修，但在与鲁路修的个人骑士枢木朱雀及其Knightmare Frame Z-01Z兰斯洛特·阿尔比昂的单挑中被击败。特里斯坦受损但仍能运作，后被黑色骑士团升级为新形式RZA-3F9X1特里斯坦分离者。</p>`
    },
    {
        id: 40,
        name_zh: "特里斯坦 分离者",
        name_en: "Tristan Divider",
        model: "RZA-3F9X1",
        faction: "black-knights",
        generation: "第7世代",
        type: "专用机",
        ...
        images: [
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d0b093aa9.webp",
                description: "原始配色"
            },
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d0b1348c9.webp",
                description: "绿色力量配色"
            }
        ],
        image: "https://cdn4.winhlb.com/2025/10/29/6901d0b093aa9.webp",
        description: "特里斯坦分离者是特里斯坦被拉克夏塔团队重建后的形态，采用了黑色骑士团的技术，并装备了由加拉哈德的\"埃克斯卡利伯\"修复而成的两把分离剑。",
        specs: {
            height: "5.45m",
            weight: "9.55t",
            armor: "钨",
            power: "樱石能源块",
            developer: "拉克夏塔·恰拉及其团队",
            derivedFrom: "特里斯坦; 加拉哈德（\"埃克斯卡利伯\"微波振动剑）"
        },
        equipment: {
            standard: [
                { name: "飞燕爪牙推进器", description: "" },
                { name: "陆地滑行推进系统", description: "" },
                { name: "空力滑翔系统", description: "黑色骑士团型号，取代了不列颠尼亚集成浮空系统" },
                { name: "驾驶舱弹射系统", description: "" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x \"埃克斯卡利伯\"微波振动剑", description: "由加拉哈德的埃克斯卡利伯断剑修复而成的两把分离剑" },
                { name: "2x 臂装式飞燕爪牙", description: "安装在前臂的飞燕爪牙" },
                { name: "1x 能量炮", description: "由飞燕爪牙组合形成的能量武器" }
            ],
            optional: [
                { name: "2x 机枪", description: "仅在堡垒模式使用" }
        ...
        design: `<p>特里斯坦分离者不再使用不列颠尼亚集成浮空系统，而是采用了黑色骑士团型号的空力滑翔系统。其头部单元经过重新设计，类似于加拉哈德，拥有更长的红色角。MVS长柄武器被替换为由加拉哈德的埃克斯卡利伯断剑修复而成的两把分离剑。此外，它保留了前身的堡垒模式变形能力。</p>`,
        combat: `<p>在吉诺被朱雀击败后，特里斯坦由拉克夏塔的团队重建并命名为"特里斯坦分离者"。吉诺使用它来保卫达摩克利斯，迅速击败了鲁路修的神虎，但很快被朱雀的兰斯洛特·阿尔比昂战胜，在腰部被切断成两半。尽管处于这种状态，吉诺仍成功在卡莲受损的红莲圣天八极式被朱雀及其兰斯洛特·阿尔比昂几乎摧毁后，从自由落体中救出了她。</p>`
    },
    {
        id: 41,
        name_zh: "文森特",
        ...
        type: "试作机",
        pilot: "罗洛·兰佩洛基",
        image: "https://cdn4.winhlb.com/2025/10/29/6901d0b1285ca.webp",
        description: "文森特是第七世代限量生产原型Knightmare Frame，基于兰斯洛特的反馈数据开发，旨在成为其量产型号。虽由不列颠尼亚军方开发，后为黑色骑士团所用。",
        specs: {
            height: "4.44m",
            weight: "6.99t",
            armor: "钨",
            power: "樱石能源块",
            developer: "神圣不列颠帝国",
            derivedFrom: "兰斯洛特; 兰斯洛特俱乐部; 兰斯洛特圣杯; 兰斯洛特试验型",
            development: "文森特指挥官型",
            variants: "文森特·格拉姆; 文森特·格林达; 文森特·普鲁顿定制型; 等"
        },
        equipment: {
            standard: [
                { name: "驾驶舱弹射系统", description: "" },
                { name: "事实球传感器", description: "两个传感器安装在肩部而非胸部" },
                { name: "陆地滑行推进系统", description: "除脚部标准滑行轮外，肩部还装有第二组滑行轮，极大增强机动性" }
            ],
            optional: [
                { name: "空力滑翔系统", description: "黑色骑士团为其加装的飞行系统" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x 臀部安装飞燕爪牙", description: "" },
                { name: "2x 肘部安装针刺爆破器", description: "发射短程高聚焦能量冲击，能穿透Knightmare装甲" },
                { name: "2x 长枪型微波振动剑", description: "可在刀柄处连接形成双刃MVS长枪" }
            ],
            handheld: [
                { name: "1x 左臂安装双管手枪", description: "类似晓机装备的手枪，由黑色骑士团加装" }
            ]
        },
        design: `<p>RPI-212文森特旨在成为受兰斯洛特启发的量产模型。其开发所用的大部分数据和研究都来自兰斯洛特的战斗历史。尽管它源自兰斯洛特，但其实际设计仍与前身有很大不同，虽然失去了兰斯洛特的一些关键元素（如VARIS步枪和光辉屏障系统），但目标是使单位更经济实惠，同时仍保持优异的性能和效率水平。</p><p>文森特像兰斯洛特一样有两个事实球传感器，但传感器安装在肩部而非胸部。它配备了飞燕爪牙，但只有两个安装在臀部。其固定的微波振动剑形状像长矛而非传统长剑，两者可在刀柄处连接形成双刃MVS长枪。文森特还引入了一种称为"针刺爆破器"的武器装备。这种固定装置位于双肘，由为兰斯洛特"光辉屏障"提供动力的相同技术开发。它通过发射短程高聚焦能量冲击来工作，可以穿透Knightmare装甲并产生毁灭性效果。</p>`,
        combat: `<p>文森特限量生产模型于2018年a.t.b.首次由神圣不列颠帝国部署。它被借给秘密情报办公室，由其顶级刺客之一罗洛·兰佩洛基驾驶，文森特首次亮相是在巴别塔围攻期间，它与黑色骑士团Knightmare单位交战并超越之。文森特随后被交给不列颠尼亚军方，用于处决剩余的黑色骑士团领导人。罗洛最终叛逃到黑色骑士团一方时带走了这台原型机。在此期间，文森特配备了黑色骑士团的空力滑翔系统，为袭击Geass教团做准备。该单位在整个第二季的大部分时间里作为罗洛的个人Knightmare，直到在与V.V.驾驶的齐格弗里德的战斗中严重受损。</p>`
    },
    {
        id: 42,
        name_zh: "文森特指挥官型",
        name_en: "Vincent Commander Model",
        model: "RPI-212A",
        faction: "britannia",
        generation: "第7世代",
        type: "指挥官用机",
        pilot: "基尔伯特·G·P·基尔福特;卢西亚诺·布拉德利;玛莉卡·索雷西;等",
        images: [
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d394aed35.webp",
                description: "吉尔福德配色"
            },
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d394d0760.webp",
                description: "格劳萨姆·瓦尔基里中队配色"
            },
            {
                url: "https://cdn4.winhlb.com/2025/10/29/6901d393bf634.webp",
                description: "皇家卫队配色"
            }
        ],
        image: "https://cdn4.winhlb.com/2025/10/29/6901d394aed35.webp",
        description: "文森特指挥官型是第七世代初期限量生产原型机文森特的改进版本，由神圣不列颠帝国少量生产，供战场指挥官和精英部队使用，最终取代格洛斯特成为不列颠尼亚前线高性能单位。",
        specs: {
            height: "4.44m",
            weight: "7.13t",
            armor: "钨",
        ...
        equipment: {
            standard: [
                { name: "驾驶舱弹射系统", description: "" },
                { name: "事实球传感器", description: "两个传感器安装在肩部" },
                { name: "陆地滑行推进系统", description: "除脚部标准滑行轮外，肩部还装有第二组滑行轮，可即时切换前后方向，极大增强机动性" },
                { name: "浮空单元", description: "标准装备，提供空战能力" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2x 臀部安装飞燕爪牙", description: "" },
                { name: "2x 肘部安装针刺爆破器", description: "发射短程高聚焦能量冲击，能穿透Knightmare装甲并产生毁灭性效果" },
                { name: "2x 长枪型微波振动剑", description: "可在刀柄处连接形成双刃MVS长枪" }
            ],
            handheld: [
                { name: "1x 突击步枪", description: "与前辈Knightmare Frame使用的武器相同" }
            ]
        },
        design: `<p>RPI-212A文森特指挥官型旨在成为原始文森特单位的量产模型，因此A型从其前身大大改进，同时仍能保持原始单位在不列颠尼亚操作期间取得的初步成功和高性能。原始单位的几乎所有方面和系统都得到了极大改进，具有增强的航空电子设备（涵盖多种系统，包括通信、导航、多系统的显示和管理，以及安装在单位上的数百个其他系统，允许执行单独功能）并配备更好的对抗ECM和Gefjun干扰器的屏蔽技术，这项技术能够禁用如兰斯洛特这样的Knightmare Frame，而文森特系列正是从兰斯洛特汲取了巨大灵感。除此之外，文森特指挥官型与测试平台单位几乎相同，唯一的区别是它在每个领域都得到了极大改进，使其能够部署到现役军事服务中。</p><p>外观上，文森特指挥官型的框架和装甲设计与原始文森特完全相同。陆军使用的标准单位采用银色主体和深紫色装饰颜色，尽管一些特殊团体被显示在其文森特指挥官型单位上有不同的颜色，例如女武神中队采用浅粉色和洋红色，而皇帝皇家护卫队则采用绿色和金色。</p>`,
        combat: `<p>文森特指挥官型是原型文森特的生产版本，少量生产，专供战场指挥官和熟练飞行员使用。其首台单位于2018年a.t.b.由不列颠尼亚军方在太平洋战役期间部署（当时鲁路修·vi·不列颠尼亚和黑色骑士团试图绑架11区新任总督娜娜莉·vi·不列颠尼亚），领导从阿瓦隆派遣的增援部队，由基尔伯特·G·P·基尔福特驾驶。尽管文森特指挥官型由于配备了浮空单元而具有空战能力，在战斗中获得了初步优势（这是黑色骑士团地面Knightmare所不具备的），但该单位最终被红月卡莲在承受红莲可翔式的辐射波动臂一击后摧毁。然而，基尔福特获得了一台替换的文森特指挥官型，他在系列的后续剧集中驾驶。</p><p>由第十圆桌骑士卢西亚诺·布拉德利领导的女武神中队的四名成员，包括玛莉卡·索雷西和莉莉安娜·维加蒙，驾驶配备浮空单元的浅粉色和洋红色文森特指挥官型。然而，所有这四台单位在第二次东京战役中被红莲圣天八极式单方面摧毁。第十二圆桌骑士莫妮卡·克鲁谢夫斯基被显示指挥查理·zi·不列颠皇帝的个人皇家护卫队，他们在鲁路修袭击神根岛期间驾驶绿色和金色的文森特指挥官型（一种称为文森特4的变体），从其旗舰大不列颠尼亚号部署以消灭敌军。不用说，这些单位不幸地被装备浮空系统的萨瑟兰在飞行员受鲁路修Geass影响的突袭中摧毁。</p>`
    },
    {
        id: 43,
        name_zh: "斩月",
        ...
        type: "专用机",
        pilot: "藤堂镜志朗",
        image: "https://cdn4.winhlb.com/2025/10/31/6904944205b99.webp",
        description: "斩月是由藤堂镜志朗驾驶的Knightmare Frame，在动画《Code Geass：反叛的鲁路修R2》中首次登场。它是拉克夏塔·恰拉为黑色骑士团新生产的Knightmare之一。斩月是作为战场指挥官藤堂的定制机开发的，其规格允许它与兰斯洛特匹敌。继月下之后，它被开发为藤堂镜志朗的定制机，是红莲系列的高性能KMF。它不仅拥有超过晓直参的规格，还配备了月下（藤堂版）的冲击扩散柔性纤维、制导刀横贯灼括刀近战武器，以及转用辐射波技术的辐射屏障新防御装备。其战斗能力接近红莲可翔式，甚至能与枢木朱雀的兰斯洛特征服者竞争。",
        specs: {
            height: "4.81m",
            weight: "8.26t",
            armor: "钨",
        ...
        equipment: {
            standard: [
                { name: "驾驶舱弹射系统", description: "利用火箭助推器使驾驶舱与KMF分离" },
                { name: "高速机械竞速驱动轮", description: "存储在腿结构内，用于地面高速巡航，可执行枢轴和旋转转弯。部署时，小腿变为中空结构。" },
                { name: "集成环境数据处理组件", description: "黑色骑士团对事实球的称呼。高效传感器，提供环境信息给驾驶员，安装在头部。当机体未启动时缩回躯干。" },
                { name: "冲击扩散柔性纤维", description: "从月下（藤堂版）继承的多功能头发状装备。头后部的两个锁可以散热、增强通信和用于格挡敌人近战攻击。" },
                { name: "辐射屏障发生器", description: "安装在头侧天线的小型辐射波系统，在KMF前方部署辐射能量盾。攻击性辐射波技术被转用于防御目的，成为黑色骑士团相当于不列颠尼亚光辉盾牌的装备。启动时，侧天线向侧面分开，露出发出红光的发生器。" }
            ],
            optional: []
        },
        weapons: {
        ...
        design: "斩月是由藤堂镜志朗驾驶的Knightmare Frame，在动画《Code Geass：反叛的鲁路修R2》中首次登场。它是拉克夏塔·恰拉为黑色骑士团新生产的Knightmare之一。斩月是作为战场指挥官藤堂的定制机开发的，其规格允许它与兰斯洛特匹敌。继月下之后，它被开发为藤堂镜志朗的定制机，是红莲系列的高性能KMF。它不仅拥有超过晓直参的规格，还配备了月下（藤堂版）的冲击扩散柔性纤维、制导刀横贯灼括刀近战武器，以及转用辐射波技术的辐射屏障新防御装备。其战斗能力接近红莲可翔式，甚至能与枢木朱雀的兰斯洛特征服者竞争。",
        combat: ""
    }
];
