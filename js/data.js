...
const knightmareFrames = [
    {
        ...
        description: "晓 直参仕样是黑色骑士团中队长们驾驶的晓系列 Knightmare 框架的变体机型。与标准的晓量产型相比，它的外观更接近月下。千叶凪沙、朝比奈省悟及其他中队长驾驶的是深蓝色版本。C.C. 驾驶的则是该机体的粉色版本。",
        specs: {
            height: "4.81m",
            weight: "8.26t",
            armor: "钨",
    ...
    },
    {
        ...
        description: "斩月（Zangetsu）由藤堂镜志朗驾驶，是动画《反叛的鲁路修R2》中登场的 Knightmare Frame 机体。这台由拉克夏塔·恰拉为黑色骑士团研发的新型 Knightmare，作为战场指挥官藤堂的专用机，其性能足以与兰斯洛特分庭抗礼。",
        specs: {
            height: "4.81m",
            weight: "8.26t",
            armor: "钨",
        ...
        design: "该机体继月下之后，作为藤堂镜志朗专用机被开发而成，属于红莲系列的高性能KMF。不仅整体性能超越晓·直参仕样，同时配备了月下（藤堂专用型）的冲击扩散软甲材料、同款近战武器「锷刀双刃」以及运用辐射波动技术衍生的新型防御装备「辐射屏障」。其战斗能力逼近红莲可翔式，甚至能与枢木朱雀驾驶的兰斯洛特·征服者抗衡。",
        combat: ""
    }
];
