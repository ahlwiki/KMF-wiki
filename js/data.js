...
const knightmareFrames = [
    {
        ...
        design: `<p>黑色骑士团的工程师拉克夏塔·恰拉设计了这款指挥官单位，命名为"直参式样"。"直参"是日语中对于将军直属部下的旧称。该指挥官机的性能水平超越了基础型晓，其一个重要特征是头部安装的一对辐射波发生器，使其能够像贰式格莲贰型一样生成防御性屏障。</p><p>它配备了与标准晓类似的武器，但使用的是全尺寸的回旋刃刀，而非缩短的警棍版本。在其可选武器中，二联装手枪和辐射波导弹是最常见的。它们也可以使用可选的空降滑翔翼单元，相应的，机体型号会变更为 Type-05S/F2F 晓 直参空战式样。</p>`
    },
    {
        id: 2,
        name_zh: "晓 量产型",
    ...
    },
    {
        ...
        generation: "第5世代",
        type: "试作机",
        pilot: "马里奥·加菲尔德、玛雅·加菲尔德",
        image: "https://s21.ax1x.com/2025/10/23/pVXEko4.webp",
        descriptiondescription: "阿朗泰特是出现在《Code Geass：反叛的鲁路修 失落的 stories》中的机体。由卡梅洛特建造，供其测试驾驶员使用，以测试兰斯洛特的装备用于量产。这个名字来源于亚瑟王赠予兰斯洛特爵士的剑，它是埃克斯卡利伯剑的姊妹剑。",
        specs: {
            height: "4.41m",
            weight: "7.95t",
            armor: "钨",
            power: "樱石能源块",
            developer: "卡梅洛特",
            derivedFrom: "萨瑟兰定制型、兰斯洛特"
        },
        equipment: {
            standard: [
                { name: "驾驶舱弹射系统", description: "利用火箭助推器使驾驶舱与KMF分离" },
                { name: "陆地滑行推进系统", description: "利用脚跟处的动力轮大幅提升KMF的机动性" },
                { name: "光辉盾牌", description: "产生能量屏障防御攻击" },
                { name: "额外大型外部能源填充器", description: "提供额外能源以支持高能耗装备" }
            ]
        },
        weapons: {
            fixed: [
                { name: "2 × 飞燕爪牙", description: "" }
            ],
            optional: [
                { name: "1 × VARIS步枪", description: "" },
                { name: "2 × 微波振动剑", description: "" }
            ]
        },
        design: `<p>希望为普通士兵量产兰斯洛特。卡梅洛特将使用萨瑟兰作为基础，同时使用萨瑟兰定制型的数据。与仅携带VARIS步枪的萨瑟兰定制型不同，阿朗泰特将使用大部分兰斯洛特装备，包括两把MVS剑、一把VARIS步枪、两个光辉盾牌和肩部的两个Factsphere，但只有两个飞燕爪牙。由于高能耗，像萨瑟兰定制型一样安装了额外能源填充器。</p>`,
        combat: `<p>卡梅洛特与其他研发小组一起被任务创建为普通士兵量产兰斯洛特的计划，称为文森特计划。对于卡梅洛特，创建了一个测试单位，阿朗泰特，以加菲尔德为主要测试驾驶员。它的第一次任务是参与人质救援，与两个定制萨瑟兰一起。阿朗泰特将继续参与行动，直到在太平洋上空的战斗中被最终摧毁，加菲尔德失踪。由于这一 unforeseen 情况，其测试数据未用于文森特，而是兰斯洛特试验的测试数据被用于文森特。</p>`
    },
    {
        id: 4,
        name_zh: "巴米德斯",
